define(["exports", "../../lit/index.js", "./lib/simple-toolbar-more-button.js", "./lib/simple-toolbar-field.js", "./lib/simple-toolbar-button-group.js", "./lib/simple-toolbar-button.js"], function (_exports, _index, _simpleToolbarMoreButton, _simpleToolbarField, _simpleToolbarButtonGroup, _simpleToolbarButton) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.SimpleToolbarBehaviors = _exports.SimpleToolbar = void 0;

  var _templateObject_5320bf20c7f611eca0cec37507546830, _templateObject2_5320bf20c7f611eca0cec37507546830, _templateObject3_5320bf20c7f611eca0cec37507546830, _templateObject4_5320bf20c7f611eca0cec37507546830;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        get: function get() {
          ...
          return (0, _index.html)(_templateObject_5320bf20c7f611eca0cec37507546830 || (_templateObject_5320bf20c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral([" <simple-toolbar-more-button\n        id=\"morebutton\"\n        .align-horizontal=\"", "\"\n        .align-vertical=\"", "\"\n        aria-controls=\"buttons\"\n        class=\"button\"\n        @click=\"", "\"\n        ?disabled=", "\n        @toggle=\"", "\"\n        ?hidden=", "\n        .icon=\"", "\"\n        .icon-position=\"", "\"\n        .label=\"", "\"\n        .shortcut=\"", "\"\n        ?show-text-label=\"", "\"\n        ?toggled=\"", "\"\n        .toggled-icon=\"", "\"\n        .toggled-label=\"", "\"\n        .toggled-tooltip=\"", "\"\n        .tooltip-direction=\"", "\"\n        part=\"morebutton\"\n      >\n      </simple-toolbar-more-button>"])), this.alignHorizontal, this.alignVertical, function (e) {
        ...
        key: "toolbarTemplate",
        get: function get() {
          return (0, _index.html)(_templateObject2_5320bf20c7f611eca0cec37507546830 || (_templateObject2_5320bf20c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n        <div\n          id=\"buttons\"\n          class=\"", "\"\n          part=\"buttons\"\n        >\n          <slot></slot>\n        </div>\n        ", "\n      "])), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.alwaysExpanded ? "" : this.moreButton);
        }
      }, {
        ...
        value: function deregisterButton(button) {
          ...
          (button.shortcutKeys || "").split(" ").forEach(function (key) {
            return delete _this5.shortcutKeys[key];
          });
        ...
        value: function registerButton(button) {
          ...
          this.__buttons = babelHelpers.toConsumableArray(new Set(this.__buttons));
          (button.shortcutKeys || "").split(" ").forEach(function (key) {
            return _this6.shortcutKeys[key] = button;
          });
        ...
        value: function resizeToolbar() {
          ...
          var items = babelHelpers.toConsumableArray(this.children || []),
              shown = true;
        ...
        value: function focusOn(item) {
          ...
          if (delay) {
            setTimeout(function () {
              return _this7.currentItem.focus();
            }, 300);
          } else {
        ...
        value: function updateToolbar() {
          ...
          this.clearToolbar();
          if (babelHelpers.typeof(this.config) != babelHelpers.typeof([])) this.config = JSON.parse(config);
        ...
        value: function _addConfigItems() {
          ...
          (items || []).forEach(function (config) {
            if (config.type === "button-group" || config.type === "simple-toolbar-button-group") {
              _this8.addButtonGroup(config, parent);
            } else {
              _this8.addButton(config, parent);
            }
          });
        }
        /**
        ...
        value: function _handleToggleToolbar(e) {
          this.collapsed = e.detail && babelHelpers.typeof(e.detail) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) ? e.detail : !this.collapsed;
        }
        /**
        ...
        key: "properties",
        get: function get() {
          return _objectSpread(_objectSpread({}, _simpleToolbarButton.SimpleToolbarGlobalProperties), {}, {
            /**
  ...
  _exports.SimpleToolbarBehaviors = SimpleToolbarBehaviors;

  var SimpleToolbar = /*#__PURE__*/function (_SimpleToolbarBehavio) {
    babelHelpers.inherits(SimpleToolbar, _SimpleToolbarBehavio);

    var _super2 = _createSuper(SimpleToolbar);

    function SimpleToolbar() {
      babelHelpers.classCallCheck(this, SimpleToolbar);
      return _super2.apply(this, arguments);
    }

    return babelHelpers.createClass(SimpleToolbar);
  }(SimpleToolbarBehaviors(_index.LitElement));

  _exports.SimpleToolbar = SimpleToolbar;
