define(["exports", "require", "../../lit/index.js", "../utils/utils.js"], function (_exports, _require, _index, _utils) {
  ...
  var _templateObject_51609890c7f611eca0cec37507546830, _templateObject2_51609890c7f611eca0cec37507546830, _templateObject3_51609890c7f611eca0cec37507546830, _templateObject4_51609890c7f611eca0cec37507546830, _templateObject5_51609890c7f611eca0cec37507546830, _templateObject6_51609890c7f611eca0cec37507546830, _templateObject7_51609890c7f611eca0cec37507546830;
  ...
  var PageContentsMenu = /*#__PURE__*/function (_LitElement) {
    ...
    function PageContentsMenu() {
      ...
      _this.scrollPolling = 100; // only useful with mobile
    ...
    babelHelpers.createClass(PageContentsMenu, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_51609890c7f611eca0cec37507546830 || (_templateObject_51609890c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n      <section class=\"wrapper\" role=\"navigation\">\n        <div class=\"header\">\n          <a\n            class=\"svg\"\n            @click=\"", "\"\n            @keypress=\"", "\"\n            id=\"popovertarget\"\n            aria-label=\"", "\"\n          >\n            <svg\n              preserveAspectRatio=\"xMidYMid meet\"\n              height=\"1em\"\n              width=\"1em\"\n              fill=\"none\"\n              xmlns=\"http://www.w3.org/2000/svg\"\n              viewBox=\"0 0 24 24\"\n              stroke-width=\"2\"\n              stroke-linecap=\"round\"\n              stroke-linejoin=\"round\"\n              stroke=\"currentColor\"\n              class=\"icon-7f6730be--text-3f89f380\"\n            >\n              <g>\n                <line x1=\"21\" y1=\"10\" x2=\"7\" y2=\"10\"></line>\n                <line x1=\"21\" y1=\"6\" x2=\"3\" y2=\"6\"></line>\n                <line x1=\"21\" y1=\"14\" x2=\"3\" y2=\"14\"></line>\n                <line x1=\"21\" y1=\"18\" x2=\"7\" y2=\"18\"></line>\n              </g>\n            </svg>\n          </a>\n          <simple-tooltip\n            for=\"popovertarget\"\n            offset=\"32\"\n            ?hidden=\"", "\"\n          >\n            ", "\n          </simple-tooltip>\n          ", "\n        </div>\n        ", "\n      </section>\n    "])), this.toggleSettings, this.keyToggle, this.label, !this.mobile || !this.hideSettings, this.label, !this.mobile ? (0, _index.html)(_templateObject2_51609890c7f611eca0cec37507546830 || (_templateObject2_51609890c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral([" <h2 class=\"label\">", "</h2> "])), this.label) : "", this.mobile ? (0, _index.html)(_templateObject3_51609890c7f611eca0cec37507546830 || (_templateObject3_51609890c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n              <simple-popover\n                class=\"dropdown pull-left font-settings js-toolbar-action settings-container\"\n                ?hidden=\"", "\"\n                position=\"", "\"\n                auto\n              >\n                <ol class=\"contents\">\n                  ", "\n                </ol>\n              </simple-popover>\n            "])), this.hideSettings, this.position, this.items.map(function (item, index) {
          return _this2.renderItem(item, index);
        })) : (0, _index.html)(_templateObject4_51609890c7f611eca0cec37507546830 || (_templateObject4_51609890c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n              <ol class=\"contents\">\n                ", "\n              </ol>\n            "])), this.items.map(function (item, index) {
          return _this2.renderItem(item, index);
        })));
      }
    }, {
      ...
      value: function renderItem(item, index) {
        if (item.link == null && item.object) {
          ...
          return (0, _index.html)(_templateObject5_51609890c7f611eca0cec37507546830 || (_templateObject5_51609890c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n        <li class=\"item\">\n          <a\n            class=\"link indent-", " ", "\"\n            tabindex=\"0\"\n            @click=\"", "\"\n            @keypress=\"", "\"\n            data-index=\"", "\"\n            >", "</a\n          >\n        </li>\n      "])), item.indent, item.active, this.scrollToObject, this.keyScroll, index, item.title);
        }

        return (0, _index.html)(_templateObject6_51609890c7f611eca0cec37507546830 || (_templateObject6_51609890c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n      <li class=\"item\">\n        <a\n          class=\"link indent-", " ", "\"\n          href=\"", "\"\n          @click=\"", "\"\n          @keypress=\"", "\"\n          data-index=\"", "\"\n          >", "</a\n        >\n      </li>\n    "])), item.indent, item.active, item.link, this.scrollToObject, this.keyScroll, index, item.title);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "items" && _this3[propName] && _this3[propName].length > 0) {
            setTimeout(function () {
              _this3.scrollFinished();
            }, 0);
          }

          if (propName == "contentContainer") {
            _this3._contentContainerChanged(_this3[propName]);
            ...
            if (_this3[propName]) {
              new Promise(function (res, rej) {
                ...
                setTimeout(function () {
                  ...
                  _this3.__toggleTarget = _this3.shadowRoot.querySelector("#popovertarget");

                  _this3.__toggleTarget.setAttribute("tabindex", "0");

                  _this3.shadowRoot.querySelector("simple-popover").target = _this3.__toggleTarget;
                }, 0);
              });
              new Promise(function (res, rej) {
                return _require.default(["../simple-tooltip/simple-tooltip.js"], res, rej);
              });
            } else if (oldValue && !_this3[propName]) {
              _this3.__toggleTarget.removeAttribute("tabindex");
            }
          }
        });
      }
      ...
      value: function scrollFinished() {
        ...
        if (this.items) {
          ...
          this.items.forEach(function (value, i) {
            var itemTop = _this5.items[i].object.getBoundingClientRect().top - 100;
            var itemBottom = 0; // ensure bottom is ACTUALLY set to the top of the NEXT item

            if (i !== _this5.items.length - 1) {
              itemBottom = _this5.items[i + 1].object.getBoundingClientRect().top - 100;
            } else {
            ...
            if (itemTop <= browserViewport && itemBottom > 0 && !activeFound) {
              activeFound = true;
              _this5.items[i].active = "active";
            } else {
              _this5.items[i].active = "";
            }
          ...
          if (!activeFound && this.items && this.items.length > 0) {
            ...
            if (this.items[0].object.getBoundingClientRect().top >= browserViewport) {
