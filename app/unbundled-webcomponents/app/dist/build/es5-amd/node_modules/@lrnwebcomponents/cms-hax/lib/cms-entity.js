define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../../@polymer/paper-spinner/paper-spinner.js", "../../utils/utils.js"], function (_exports, _polymerElement, _flattenedNodesObserver, _async, _ironAjax, _paperSpinner, _utils) {
  ...
  var _templateObject_e8f12840941711ec8d52c707f928eca0;
  ...
  var CMSEntity = /*#__PURE__*/function (_PolymerElement) {
    ...
    babelHelpers.createClass(CMSEntity, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_e8f12840941711ec8d52c707f928eca0 || (_templateObject_e8f12840941711ec8d52c707f928eca0 = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          min-width: 112px;\n          min-height: 112px;\n          transition: 0.6s all ease;\n          background-color: transparent;\n        }\n        :host([hax-edit-mode]) #replacementcontent {\n          pointer-events: none;\n        }\n        paper-spinner {\n          visibility: hidden;\n          opacity: 0;\n          height: 80px;\n          width: 80px;\n          padding: 16px;\n        }\n        #replacementcontent {\n          visibility: visible;\n          opacity: 1;\n        }\n        :host([loading]) {\n          text-align: center;\n        }\n        :host([loading]) paper-spinner {\n          visibility: visible;\n          opacity: 1;\n        }\n        :host([loading]) #replacementcontent {\n          opacity: 0;\n          visibility: hidden;\n        }\n      </style>\n      <iron-ajax\n        id=\"entityrequest\"\n        method=\"GET\"\n        params=\"[[bodyData]]\"\n        url=\"[[entityEndPoint]]\"\n        handle-as=\"json\"\n        last-response=\"{{entityData}}\"\n      ></iron-ajax>\n      <paper-spinner active=\"[[loading]]\"></paper-spinner>\n      <span id=\"replacementcontent\"><slot></slot></span>\n    "])));
      }
    }, {
      key: "tag",
      get: function get() {
