...
function _templateObject3_a79ded70c7f611eca0cec37507546830() {
  var data = _taggedTemplateLiteral(['<slot name="menuitem"></slot>']);

  _templateObject3_a79ded70c7f611eca0cec37507546830 = function _templateObject3_a79ded70c7f611eca0cec37507546830() {
    return data;
  };
...
function _templateObject2_a79ded70c7f611eca0cec37507546830() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="menubutton"\n        aria-haspopup="true"\n        aria-controls="menu"\n        aria-expanded="', '"\n      >\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n          ?hidden=', '\n        ></simple-icon-lite>\n        <span class="', '"\n          >', '</span\n        >\n        <simple-icon-lite\n          id="dropdownicon"\n          icon="arrow-drop-down"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip for="menubutton" ?hidden="', '"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject2_a79ded70c7f611eca0cec37507546830 = function _templateObject2_a79ded70c7f611eca0cec37507546830() {
    return data;
  };
...
function _templateObject_a79ded70c7f611eca0cec37507546830() {
  ...
  _templateObject_a79ded70c7f611eca0cec37507546830 = function _templateObject_a79ded70c7f611eca0cec37507546830() {
    return data;
  };
...
var HaxButtonMenu = /*#__PURE__*/function (_A11yMenuButtonBehavi) {
  ...
  _createClass(HaxButtonMenu, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxButtonMenu), "styles", this)), [(0, _litElement.css)(_templateObject_a79ded70c7f611eca0cec37507546830())]);
    }
  }]);
  ...
  function HaxButtonMenu() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HaxButtonMenu).call(this));
  ...
  _createClass(HaxButtonMenu, [{
    ...
    key: "buttonTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject2_a79ded70c7f611eca0cec37507546830(), this.expanded ? "true" : "false", this.icon, !this.icon, !this.icon || this.showTextLabel ? "label" : "sr-only", this.label, !this.icon, this.label);
    }
    /**
    ...
    get: function get() {
      return (0, _litElement.html)(_templateObject3_a79ded70c7f611eca0cec37507546830());
    }
  }], [{
    key: "tag",
    get: function get() {
    ...
    key: "properties",
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(HaxButtonMenu), "properties", this), {
        /**
         * disabled state
         */
        disabled: {
