define(["exports", "../../lit/index.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icon-button-lite.js", "../../web-dialog/index.js"], function (_exports, _index, _simpleIcons, _simpleIconLite, _simpleIconButtonLite, _index2) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.SimpleModalStore = _exports.SimpleModalCssVars = _exports.SimpleModal = void 0;

  var _templateObject_52efeb20c7f611eca0cec37507546830, _templateObject2_52efeb20c7f611eca0cec37507546830, _templateObject3_52efeb20c7f611eca0cec37507546830;
  ...
  _exports.SimpleModalCssVars = SimpleModalCssVars;
  ...
  var SimpleModal = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_52efeb20c7f611eca0cec37507546830 || (_templateObject_52efeb20c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n     <web-dialog\n       id=\"dialog\"\n       center\n       role=\"dialog\"\n       part=\"dialog\"\n       aria-describedby=\"simple-modal-content\"\n       aria-label=\"", "\"\n       aria-labelledby=\"", "\"\n       aria-modal=\"true\"\n       ?open=\"", "\"\n       @open=\"", "\"\n       @close=\"", "\"\n     >\n       <div id=\"titlebar\" part=\"titlebar\">\n         <h2 id=\"simple-modal-title\" ?hidden=\"", "\" part=\"title\">\n           ", "\n         </h2>\n         <div></div>\n         ", "\n       </div>\n       <div id=\"headerbar\" part=\"headerbar\"><slot name=\"header\"></slot></div>\n       <div id=\"simple-modal-content\" part=\"content\">\n         <slot name=\"content\"></slot>\n       </div>\n       <slot name=\"custom\" part=\"custom\"></slot>\n       <div class=\"buttons\" part=\"buttons\">\n         <slot name=\"buttons\"></slot>\n       </div>\n     </web-dialog>"])), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.open, this.close, !this.title, this.title, !this.modal ? (0, _index.html)(_templateObject2_52efeb20c7f611eca0cec37507546830 || (_templateObject2_52efeb20c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n           id=\"close\"\n           dark\n           icon=\"", "\"\n           @click=\"", "\"\n           label=\"", "\"\n           part=\"close\"\n         >\n         </simple-icon-button-lite>"])), this.closeIcon, this.close, this.closeLabel) : "");
      ...
      value: function showEvent(e) {
        ...
        if (this.opened) {
          ...
          this.innerHTML = "";
          setTimeout(function () {
            _this4.show(e.detail.title, e.detail.mode, e.detail.elements, e.detail.invokedBy, e.detail.id, e.detail.modalClass, e.detail.styles, e.detail.clone, e.detail.modal);
          }, 0);
        } else {
          this.show(e.detail.title, e.detail.mode, e.detail.elements, e.detail.invokedBy, e.detail.id, e.detail.modalClass, e.detail.styles, e.detail.clone, e.detail.modal);
        }
      }
      /**
      ...
      value: function show(title, mode, elements, invokedBy) {
        ...
        var modalClass = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
        var styles = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : null;
        var clone = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : false;
        var modal = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : false;
      ...
      value: function open() {
        this.opened = true;
        var wd = this.shadowRoot.querySelector("web-dialog"); // modal mode kills off the ability to close the dialog
