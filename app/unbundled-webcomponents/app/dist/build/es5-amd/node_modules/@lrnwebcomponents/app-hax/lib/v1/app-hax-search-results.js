define(["exports", "../../../simple-colors/simple-colors.js", "../../../../lit/index.js", "../../../../mobx/dist/mobx.esm.js", "./AppHaxStore.js", "../../../utils/utils.js", "./app-hax-site-bar.js", "./app-hax-site-details.js"], function (_exports, _simpleColors, _index, _mobxEsm, _AppHaxStore, _utils, _appHaxSiteBar, _appHaxSiteDetails) {
  "use strict";
  ...
  var _templateObject_d7613230c0ce11ecbdb54bb05e9423ad, _templateObject2_d7613230c0ce11ecbdb54bb05e9423ad, _templateObject3_d7613230c0ce11ecbdb54bb05e9423ad;
  ...
  var AppHaxSearchResults = /*#__PURE__*/function (_SimpleColors) {
    ...
    function AppHaxSearchResults() {
      ...
      (0, _mobxEsm.autorun)(function () {
        ...
        if (manifest && manifest.items) {
          _this.searchItems = (0, _mobxEsm.toJS)(_AppHaxStore.store.manifest.items);
    ...
    babelHelpers.createClass(AppHaxSearchResults, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_d7613230c0ce11ecbdb54bb05e9423ad || (_templateObject_d7613230c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n      <ul id=\"results\">\n        ", "\n      </ul>\n    "])), this.displayItems.map(function (item) {
          return (0, _index.html)(_templateObject2_d7613230c0ce11ecbdb54bb05e9423ad || (_templateObject2_d7613230c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["<li>\n              <app-hax-site-bar\n                @opened-changed=\"", "\"\n                ?dark=\"", "\"\n                accent-color=\"", "\"\n                icon=\"", "\"\n                icon-link=\"", "\"\n                >\n                <span slot=\"heading\">", "</span>\n                <span slot=\"subHeading\">", "</span>\n                <span slot=\"band\">", "</span>\n                <app-hax-site-details slot=\"band\"></app-hax-site-details>\n              </app-hax-site-bar>\n            </li>"])), _this3.openedChanged, _this3.dark, (0, _utils.varGet)(item, 'metadata.theme.variables.cssVariable', 'orange').replace('--simple-colors-default-theme-', '').replace('-7', ''), (0, _utils.varGet)(item, 'metadata.theme.variables.icon', 'icons:home'), 'https://iam.hax.psu.edu' + item.slug, item.title, item.author, item.description);
        }));
      }
    }, {
      key: "openedChanged",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(AppHaxSearchResults), "styles", this)), [(0, _index.css)(_templateObject3_d7613230c0ce11ecbdb54bb05e9423ad || (_templateObject3_d7613230c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          overflow: hidden;\n        }\n        ul, li {\n          margin: 0;\n          padding: 0;\n          list-style: none;\n        }\n        app-hax-site-bar {\n          margin: 8px 0;\n        }\n        \n        @media (max-width: 800px) {\n          app-hax-site-bar {\n            --main-banner-width: 60vw;\n          }\n        }\n        @media (max-width: 400px) {\n          app-hax-site-bar {\n            --main-banner-width: 90vw;\n          }\n        }\n        span[slot=\"band\"] {\n          height: 48px;\n          overflow: hidden;\n          text-overflow: ellipsis;\n          margin-bottom: 8px;\n        }\n      "])))]);
      }
    }]);
