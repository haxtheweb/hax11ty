define(["exports", "../../../lit/index.js", "../../accent-card/accent-card.js"], function (_exports, _index, _accentCard) {
  "use strict";
  ...
  var _templateObject_91609170c7f611eca0cec37507546830, _templateObject2_91609170c7f611eca0cec37507546830;
   ...
   */
  var ElmslnStudioSubmissionCard = /*#__PURE__*/function (_LitElement) {
    babelHelpers.inherits(ElmslnStudioSubmissionCard, _LitElement);

    var _super = _createSuper(ElmslnStudioSubmissionCard);

    // life cycle
    function ElmslnStudioSubmissionCard() {
      var _this;

      babelHelpers.classCallCheck(this, ElmslnStudioSubmissionCard);
      _this = _super.call(this);
      _this.horizontal = false;
      return _this;
    }

    babelHelpers.createClass(ElmslnStudioSubmissionCard, [{
      key: "render",
      value: // render function
      function render() {
        return (0, _index.html)(_templateObject_91609170c7f611eca0cec37507546830 || (_templateObject_91609170c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n      <accent-card\n        image-src=\"", "\"\n        .image-alt=\"", "\"\n        ?horizontal=\"", "\"\n        .image-align=\"", "\"\n        .image-valign=\"", "\"\n        .gravity=\"", "\"\n        no-border\n      >\n        <slot name=\"student\" slot=\"heading\"></slot>\n        <slot name=\"datetime\" slot=\"corner\"></slot>\n        <slot name=\"assigmment\" slot=\"subheading\"></slot>\n        <slot name=\"project\" slot=\"content\"></slot>\n        <slot name=\"feature\" slot=\"content\"></slot>\n        <slot name=\"feedback\" slot=\"footer\"></slot>\n      </accent-card>\n    "])), this.imageSrc || "", this.imageAlt || undefined, this.horizontal, this.imageAlign, this.imageValign, this.imageGravity);
    ...
    return ElmslnStudioSubmissionCard;
  }(_index.LitElement);

  _exports.ElmslnStudioSubmissionCard = ElmslnStudioSubmissionCard;
  customElements.define("elmsln-studio-submission-card", ElmslnStudioSubmissionCard);
});