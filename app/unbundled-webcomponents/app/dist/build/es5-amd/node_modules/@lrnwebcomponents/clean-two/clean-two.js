define(["exports", "require", "../../lit/index.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js", "../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js", "../haxcms-elements/lib/core/utils/QRCodeMixin.js", "../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js", "../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../haxcms-elements/lib/ui-components/active-item/site-active-title.js", "../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js", "../../mobx/dist/mobx.esm.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../utils/utils.js"], function (_exports, _require, _index, _HAXCMSLitElementTheme, _HAXCMSRememberRoute, _HAXCMSThemeParts, _QRCodeMixin, _HAXCMSMobileMenu, _HAXCMSOperationButtons, _haxcmsSiteStore, _siteActiveTitle, _siteBreadcrumb, _mobxEsm, _simpleIcon, _simpleIcons, _utils) {
  "use strict";
  ...
  var _templateObject_7d944df0c0ce11ecbdb54bb05e9423ad, _templateObject2_7d944df0c0ce11ecbdb54bb05e9423ad, _templateObject3_7d944df0c0ce11ecbdb54bb05e9423ad, _templateObject4_7d944df0c0ce11ecbdb54bb05e9423ad;
   ...
   * @element clean-two
   */
  var CleanTwo = /*#__PURE__*/function (_HAXCMSOperationButto) {
    babelHelpers.inherits(CleanTwo, _HAXCMSOperationButto);

    var _super = _createSuper(CleanTwo);
    ...
    function CleanTwo() {
      ...
      (0, _mobxEsm.autorun)(function (reaction) {
        if (_haxcmsSiteStore.store.activeItem && _haxcmsSiteStore.store.activeItem.metadata && _haxcmsSiteStore.store.activeItem.metadata.updated) {
          _this.pageTimestamp = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItem.metadata.updated);
        }
    ...
    babelHelpers.createClass(CleanTwo, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_7d944df0c0ce11ecbdb54bb05e9423ad || (_templateObject_7d944df0c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"body-wrapper\">\n        <div class=\"left-col\">", "</div>\n        <div class=\"content-wrapper\">\n          <div class=\"content\">\n            <header class=\"header\">\n              ", "\n              ", "\n              <site-modal\n                @site-modal-click=\"", "\"\n                ?disabled=\"", "\"\n                icon=\"icons:search\"\n                title=\"Search site\"\n                button-label=\"Search\"\n                part=\"search-btn\"\n              >\n                <site-search></site-search>\n              </site-modal>\n              <replace-tag\n                with=\"site-print-button\"\n                class=\"btn js-toolbar-action\"\n                import-method=\"view\"\n                part=\"print-btn\"\n              ></replace-tag>\n              <replace-tag\n                with=\"site-rss-button\"\n                type=\"rss\"\n                import-method=\"view\"\n                part=\"rss-btn\"\n              ></replace-tag>\n              <replace-tag\n                with=\"site-git-corner\"\n                size=\"small\"\n                circle\n                direction=\"left\"\n                import-method=\"view\"\n                part=\"git-corner-btn\"\n              ></replace-tag>\n              ", "\n            </header>\n            <site-search\n              hide-input\n              part=\"search-btn\"\n              search=\"", "\"\n              @search-item-selected=\"", "\"\n              ?hidden=\"", "\"\n            ></site-search>\n            <main>\n              <site-breadcrumb part=\"page-breadcrumb\"></site-breadcrumb>\n              <site-active-title part=\"page-title\"></site-active-title>\n              <article\n                id=\"contentcontainer\"\n                ?hidden=\"", "\"\n              >\n                <section id=\"slot\">\n                  <slot></slot>\n                </section>\n              </article>\n            </main>\n            <footer>\n              <div class=\"link-actions\">\n                <div class=\"inner\">\n                  <replace-tag\n                    with=\"site-menu-button\"\n                    import-only\n                  ></replace-tag>\n                  <site-menu-button\n                    hide-label\n                    type=\"prev\"\n                    position=\"right\"\n                    class=\"navigation\"\n                    @label-changed=\"", "\"\n                  >\n                    <div slot=\"suffix\" class=\"wrapper\">\n                      <div class=\"top\">Previous</div>\n                      <div class=\"bottom\">", "</div>\n                    </div>\n                  </site-menu-button>\n                  <site-menu-button\n                    hide-label\n                    type=\"next\"\n                    position=\"left\"\n                    class=\"navigation\"\n                    @label-changed=\"", "\"\n                  >\n                    <div slot=\"prefix\" class=\"wrapper\">\n                      <div class=\"top\">Next</div>\n                      <div class=\"bottom\">", "</div>\n                    </div>\n                  </site-menu-button>\n                </div>\n              </div>\n              <div class=\"footer\" part=\"footer\">\n                <div class=\"footer-left\" part=\"footer-left\">\n                  Last updated\n                  <replace-tag with=\"simple-datetime\" import-only></replace-tag>\n                  <simple-datetime\n                    unix\n                    .timestamp=\"", "\"\n                  ></simple-datetime>\n                </div>\n              </div>\n            </footer>\n          </div>\n        </div>\n        ", "\n      </div>\n    "])), this.HAXCMSMobileMenu(), !["lg", "xl"].includes(this.responsiveSize) ? (0, _index.html)(_templateObject2_7d944df0c0ce11ecbdb54bb05e9423ad || (_templateObject2_7d944df0c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n                    <site-menu-content\n                      .part=\"", "\"\n                      mobile\n                    ></site-menu-content>\n                  "])), this.editMode ? "edit-mode-active" : "") : "", this.HAXCMSMobileMenuButton(), this.siteModalClick, this.editMode, this.QRCodeButton(), this.searchTerm, this.searchItemSelected, this.searchTerm != "" ? false : true, this.searchTerm != "" ? true : false, this.__prevPageLabelChanged, this.prevPage, this.__nextPageLabelChanged, this.nextPage, this.pageTimestamp, ["lg", "xl"].includes(this.responsiveSize) ? (0, _index.html)(_templateObject3_7d944df0c0ce11ecbdb54bb05e9423ad || (_templateObject3_7d944df0c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"right-col\">\n                <div class=\"site-menu-content-wrapper\">\n                  <site-menu-content\n                    .part=\"", "\"\n                  ></site-menu-content>\n                </div>\n              </div>\n            "])), this.editMode ? "edit-mode-active" : "") : "");
      }
    }, {
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(CleanTwo), "properties", this)) {
          props = babelHelpers.get(babelHelpers.getPrototypeOf(CleanTwo), "properties", this);
        }
    ...
    return CleanTwo;
  }((0, _HAXCMSOperationButtons.HAXCMSOperationButtons)((0, _HAXCMSRememberRoute.HAXCMSRememberRoute)((0, _QRCodeMixin.QRCodeMixin)((0, _HAXCMSThemeParts.HAXCMSThemeParts)((0, _HAXCMSMobileMenu.HAXCMSMobileMenuMixin)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme))))));
