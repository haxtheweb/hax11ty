define(["exports", "meta", "require", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../hax-body/lib/hax-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button.js", "./utils/HAXCMSThemeParts.js", "./utils/HAXCMSI18NMixin.js", "./micros/haxcms-button-add.js", "../../../rpg-character/rpg-character.js", "../../../app-hax/lib/v1/app-hax-top-bar.js", "./haxcms-darkmode-toggle.js", "../../../../wired-elements/lib/wired-button.js"], function (_exports, meta, _require, _index, _haxcmsSiteStore, _haxStore, _mobxEsm, _utils, _simpleIcon, _simpleIcons, _simpleIconButton, _HAXCMSThemeParts2, _HAXCMSI18NMixin, _haxcmsButtonAdd, _rpgCharacter, _appHaxTopBar, _haxcmsDarkmodeToggle, _wiredButton) {
  "use strict";
  ...
  var _templateObject_e4f8cf70c0ce11ecbdb54bb05e9423ad, _templateObject2_e4f8cf70c0ce11ecbdb54bb05e9423ad;
  ...
  var HAXCMSSiteEditorUI = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_e4f8cf70c0ce11ecbdb54bb05e9423ad || (_templateObject_e4f8cf70c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n      <app-hax-top-bar>\n        <span slot=\"left\">\n          <simple-icon-lite src=\"", "\" class=\"haxLogo\" @click=\"", "\"></simple-icon-lite>\n          <slot name=\"haxcms-site-editor-ui-prefix-avatar\"></slot>\n        </span>\n      <span slot=\"center\">\n        <slot name=\"haxcms-site-editor-ui-prefix-buttons\"></slot>\n        <simple-icon-button\n          hidden\n          ?dark=\"", "\"\n          id=\"editbutton\"\n          icon=\"", "\"\n          @click=\"", "\"\n          label=\"", "\"\n          voice-command=\"edit (this) page\"\n          class=\"topbar-button\"\n          accent-color=\"green\"\n        ></simple-icon-button>\n        <simple-icon-button\n          id=\"cancelbutton\"\n          ?dark=\"", "\"\n          icon=\"icons:cancel\"\n          @click=\"", "\"\n          .hidden=\"", "\"\n          label=\"", "\"\n          voice-command=\"cancel (editing)\"\n          class=\"topbar-button\"\n          accent-color=\"red\"\n        ></simple-icon-button>\n        <simple-icon-button\n          ?dark=\"", "\"\n          id=\"editdetails\"\n          icon=\"hax:page-details\"\n          @click=\"", "\"\n          label=\"", "\"\n          voice-command=\"edit (page) details\"\n          class=\"topbar-button\"\n          accent-color=\"blue\"\n          part=\"", "\"\n          tabindex=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          part=\"", "\"\n          tabindex=\"", "\"\n          ?dark=\"", "\"\n          id=\"deletebutton\"\n          icon=\"icons:delete\"\n          @click=\"", "\"\n          label=\"", "\"\n          voice-command=\"delete page\"\n          class=\"topbar-button\"\n          accent-color=\"red\"\n        ></simple-icon-button>\n        <haxcms-button-add\n        hidden\n        ?dark-mode=\"", "\"\n        accent-color=\"purple\"\n        id=\"addbutton\"></haxcms-button-add>\n        <haxcms-button-add\n          hidden\n          ?dark-mode=\"", "\"\n          id=\"addbuttonchild\"\n          type=\"child\"\n          accent-color=\"purple\"\n        ></haxcms-button-add>\n        <haxcms-button-add\n          hidden\n          ?dark-mode=\"", "\"\n          type=\"duplicate\"\n          id=\"duplicatebutton\"\n          accent-color=\"purple\"\n        ></haxcms-button-add>\n        <simple-tooltip for=\"username\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"cancelbutton\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"editbutton\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"editdetails\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"deletebutton\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <slot name=\"haxcms-site-editor-ui-suffix-buttons\"></slot>\n      </span>\n      <span slot=\"right\">\n        <rpg-character\n          class=\"topbar-character\"\n          seed=\"", "\"\n          width=\"68\"\n          height=\"68\"\n          aria-label=\"System menu\"\n          title=\"System menu\"\n          hat=\"", "\"\n          @click=\"", "\"\n        ></rpg-character>\n        <div class=\"user-menu ", "\">\n          <div class=\"ops-panel\">\n            <wired-button\n              elevation=\"1\"\n              class=\"soundToggle\"\n              @click=\"", "\"\n            >\n              <simple-icon-lite src=\"", "\" loading=\"lazy\" decoding=\"async\"></simple-icon-lite>\n            </wired-button>\n            <haxcms-darkmode-toggle></haxcms-darkmode-toggle>\n          </div>\n          <button @click=\"", "\">\n            <simple-icon-lite icon=\"", "\"></simple-icon-lite>", "</button>\n          <button\n          id=\"outlinebutton\"\n          @click=\"", "\"\n          ><simple-icon-lite icon=\"hax:site-map\"></simple-icon-lite>", "</button>\n          <button>\n          <simple-icon-lite icon=\"add\"></simple-icon-lite>", "</button>\n          <button>\n          <simple-icon-lite icon=\"face\"></simple-icon-lite>", "</button>\n          <button class=\"logout\">", "</button>\n        </div>\n      </span>\n    </app-hax-top-bar>\n    "])), haxLogo, this.redirectToSites, !this.darkMode, this.__editIcon, this._editButtonTap, this.__editText, !this.darkMode, this._cancelButtonTap, !this.editMode, this.t.cancelEditing, !this.darkMode, this._editDetailsButtonTap, this.t.editDetails, this.editMode ? "edit-mode-active" : "", this.editMode ? "-1" : "", this.editMode ? "edit-mode-active" : "", this.editMode ? "-1" : "", !this.darkMode, this._deleteButtonTap, this.t.deletePage, this.darkMode, this.darkMode, this.darkMode, this.backText, this.t.cancelEditing, this.__editText, this.t.editDetails, this.t.deletePage, this.userName, this.rpgHat, this.toggleMenu, this.userMenuOpen ? 'open' : '', this.soundToggle, this.soundIcon, this._manifestButtonTap, this.icon, this.__settingsText, this._outlineButtonTap, this.t.editSiteOutline, this.t.startNewJourney, this.t.accountInfo, this.t.logOut);
      }
      /*
