define(["exports", "../../../../page-contents-menu/page-contents-menu.js", "../../core/utils/HAXCMSThemeParts.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../../lit/index.js"], function (_exports, _pageContentsMenu, _HAXCMSThemeParts2, _haxcmsSiteStore, _mobxEsm, _index) {
  ...
  var _templateObject_c3cbfa50c7f611eca0cec37507546830, _templateObject2_c3cbfa50c7f611eca0cec37507546830;
  ...
  var SiteMenuContent = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    function SiteMenuContent() {
      ...
      (0, _mobxEsm.autorun)(function (reaction) {
        _this.contentContainer = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.themeElement);
        setTimeout(function () {
          _this.updateMenu();
        }, 10);
    ...
    babelHelpers.createClass(SiteMenuContent, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_c3cbfa50c7f611eca0cec37507546830 || (_templateObject_c3cbfa50c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n      <div .part=\"", "\">\n        ", "\n      </div>\n    "])), this.editMode ? "edit-mode-active" : "", babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenuContent.prototype), "render", this).call(this));
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenuContent), "styles", this)), [(0, _index.css)(_templateObject2_c3cbfa50c7f611eca0cec37507546830 || (_templateObject2_c3cbfa50c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          --page-contents-menu-link-hover: var(\n            --haxcms-color,\n            var(--simple-colors-default-theme-purple-7)\n          );\n        }\n        @media screen and (max-width: 600px) {\n          .indent-1,\n          .indent-2,\n          .indent-3,\n          .indent-4,\n          .indent-5,\n          .indent-6 {\n            padding-left: 0;\n          }\n        }\n        :host([hide-if-empty][is-empty]) {\n          display: none !important;\n        }\n        simple-popover,\n        ol,\n        .item {\n          max-width: 175px;\n        }\n      "])))]);
      }
    }]);
