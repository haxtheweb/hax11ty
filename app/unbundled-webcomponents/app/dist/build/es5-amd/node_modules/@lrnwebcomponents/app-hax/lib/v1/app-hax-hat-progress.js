define(["exports", "meta", "../../../../lit/index.js", "../../../simple-colors/simple-colors.js", "../../../../mobx/dist/mobx.esm.js", "./AppHaxStore.js", "../../../promise-progress/promise-progress.js"], function (_exports, meta, _index, _simpleColors, _mobxEsm, _AppHaxStore, _promiseProgress) {
  ...
  var _templateObject_d75ac990c0ce11ecbdb54bb05e9423ad, _templateObject2_d75ac990c0ce11ecbdb54bb05e9423ad;
  ...
  var AppHaxHatProgress = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(AppHaxHatProgress, [{
        ...
        setTimeout(function () {
          ...
          _this2.shadowRoot.querySelector('#progress2').addEventListener('promise-progress-finished', function (e) {
            if (e.detail.value) {
              ...
              var createResponse = _AppHaxStore.store.AppHaxAPI.lastResponse.createSite;
              ...
              text.addEventListener('click', function () {
                window.location = (0, _mobxEsm.toJS)(_AppHaxStore.store.sitesBase).concat(createResponse.slug);
              });

              _this2.shadowRoot.querySelector('#progress2').parentNode.appendChild(text); // show you saying you got this!


              _AppHaxStore.store.toast("".concat(createResponse.title, " looks awesome, come see!"), 5000, {
                hat: 'random',
                walking: true
              });
            }
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d75ac990c0ce11ecbdb54bb05e9423ad || (_templateObject_d75ac990c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n      <img\n        src=\"", "\"\n        alt=\"\"\n      />\n      <promise-progress\n        id=\"progress2\"\n        accent-color=\"red\"\n        ?dark=\"", "\"\n        class=\"progress\"\n        .list=", "\n      ></promise-progress>\n      <div class=\"count\"><span id=\"value\">0</span>%</div>\n    "])), new URL('../assets/images/HatBlank.svg', meta.url).href, this.dark, this.promises);
      }
    }], [{
      key: "tag",
      get: function get() {
