define(["exports", "../../lit/index.js", "../simple-colors-shared-styles/simple-colors-shared-styles.js", "../a11y-utils/a11y-utils.js"], function (_exports, _index, _simpleColorsSharedStyles, _a11yUtils) {
  "use strict";
  ...
  var _templateObject_52a26760c7f611eca0cec37507546830, _templateObject2_52a26760c7f611eca0cec37507546830;
  ...
  var SimpleColorsSuper = function SimpleColorsSuper(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      function _class() {
        ...
        _this.dark = false;
        _this.colors = _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.colors;
        return _this;
      }
      ...
      babelHelpers.createClass(_class, [{
        ...
        function render() {
          return (0, _index.html)(_templateObject_52a26760c7f611eca0cec37507546830 || (_templateObject_52a26760c7f611eca0cec37507546830 = babelHelpers.taggedTemplateLiteral([" <slot></slot>"])));
        ...
        function invertShade(shade) {
          return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.invertShade(shade);
        }
        /**
        ...
        value: function getColorInfo(colorName) {
          return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getColorInfo(colorName);
        }
        /**
        ...
        value: function makeVariable() {
          ...
          return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.makeVariable(color = "grey", shade = 1, theme = "default");
        }
        /**
        ...
        value: function getContrastingColors(colorName, colorShade, isLarge) {
          return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getContrastingColors(colorName, colorShade, isLarge);
        }
        /**
         * for large or small text given a color and its shade,
        ...
        value: function getContrastingShades(isLarge, colorName, colorShade, contrastName) {
          return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.getContrastingShades(isLarge, colorName, colorShade, contrastName);
        }
        /**
        ...
        value: function isContrastCompliant(isLarge, colorName, colorShade, contrastName, contrastShade) {
          return _simpleColorsSharedStyles.SimpleColorsSharedStylesGlobal.isContrastCompliant(isLarge, colorName, colorShade, contrastName, contrastShade);
        }
      }], [{
        key: "styles",
        get: //styles function
        function get() {
          var styles = (0, _index.css)("");
  ...
  var SimpleColors = /*#__PURE__*/function (_SimpleColorsSuper) {
    babelHelpers.inherits(SimpleColors, _SimpleColorsSuper);

    var _super2 = _createSuper(SimpleColors);
    ...
    return babelHelpers.createClass(SimpleColors);
  }(SimpleColorsSuper(_index.LitElement));
