define(["exports", "../../../../lit/index.js", "./AppHaxStore.js"], function (_exports, _index, _AppHaxStore) {
  "use strict";
  ...
  var _templateObject_d75cc560c0ce11ecbdb54bb05e9423ad, _templateObject2_d75cc560c0ce11ecbdb54bb05e9423ad;
  ...
  var AppHaxSearchBar = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AppHaxSearchBar, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === 'searchItems') {
            ...
            _this2[propName] ? window.history.pushState({}, null, 'search') : window.history.pushState(null, null, _AppHaxStore.store.location.baseUrl);
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d75cc560c0ce11ecbdb54bb05e9423ad || (_templateObject_d75cc560c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button-lite ?disabled=\"", "\" label=\"Search\" icon=\"icons:search\" @click=\"", "\"></simple-icon-button-lite>\n      <input ?disabled=\"", "\" id=\"searchField\" @input=\"", "\" type=\"text\" placeholder=\"Search..\" />\n    "])), this.disabled, this.toggleSearch, !this.showSearch, this.search);
      }
    }, {
      key: "toggleSearch",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_d75cc560c0ce11ecbdb54bb05e9423ad || (_templateObject2_d75cc560c0ce11ecbdb54bb05e9423ad = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          overflow: hidden;\n        }\n        input {\n          visibility: none;\n          opacity: 0;\n          width: 0;\n          transition: all ease-in-out .3s;\n          padding: 4px;\n          font-family: 'Press Start 2P', sans-serif;\n          font-size: 20px;\n          margin: 2px 0 0 16px;\n        }\n        :host([show-search]) input {\n          visibility: visible;\n          opacity: 1;\n          width: 250px;\n          max-width: 25vw;\n        }\n        @media (max-width: 780px) {\n          :host([show-search]) input {\n            width: 250px;\n            max-width: 20vw;\n          }\n        }\n        @media (max-width: 600px) {\n          :host([show-search]) input {\n            width: 200px;\n            max-width: 20vw;\n          }\n        }\n        simple-icon-button-lite {\n          color: black;\n          --simple-icon-width: 40px;\n          --simple-icon-height: 40px;\n          padding: 2px;\n          margin: 0;\n          background-color: white;\n        }\n        simple-icon-button-lite[disabled] {\n          background-color: #CCCCCC;\n          pointer-events: none;\n          cursor: help;\n        }\n        simple-icon-button-lite:focus,\n        simple-icon-button-lite:hover {\n          background-color: #eeeeee;\n        }\n      "])))];
      }
    }]);
