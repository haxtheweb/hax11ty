define(["exports", "../../../@polymer/polymer/lib/elements/dom-repeat.js", "../../button/src/vaadin-button.js", "./vaadin-upload-icons.js", "./vaadin-upload-file.js", "../../../@polymer/polymer/lib/utils/gestures.js", "../../../@polymer/polymer/polymer-element.js", "../../component-base/src/browser-utils.js", "../../component-base/src/element-mixin.js", "../../vaadin-themable-mixin/vaadin-themable-mixin.js"], function (_exports, _domRepeat, _vaadinButton, _vaadinUploadIcons, _vaadinUploadFile, _gestures, _polymerElement, _browserUtils, _elementMixin, _vaadinThemableMixin) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.Upload = void 0;

  var _templateObject_2cf2fa50941811ec8d52c707f928eca0;
   ...
   * @mixes ElementMixin
   */
  var Upload = /*#__PURE__*/function (_ElementMixin) {
    babelHelpers.inherits(Upload, _ElementMixin);
    ...
    babelHelpers.createClass(Upload, [{
      ...
      /** @protected */
      function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(Upload.prototype), "ready", this).call(this);
      ...
      value: function _addFile(file) {
        ...
        this.files = [file].concat(babelHelpers.toConsumableArray(this.files));
      ...
      value: function _onAddFilesClick(e) {
        if (this.maxFilesReached) {
          return;
        }
    ...
    return Upload;
  }((0, _elementMixin.ElementMixin)((0, _vaadinThemableMixin.ThemableMixin)(_polymerElement.PolymerElement)));
