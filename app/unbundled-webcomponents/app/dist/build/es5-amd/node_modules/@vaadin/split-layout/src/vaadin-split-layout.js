define(["exports", "../../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js", "../../../@polymer/polymer/lib/legacy/class.js", "../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/polymer-element.js", "../../component-base/src/element-mixin.js", "../../vaadin-themable-mixin/vaadin-themable-mixin.js"], function (_exports, _ironResizableBehavior, _class, _gestureEventListeners, _flattenedNodesObserver, _polymerElement, _elementMixin, _vaadinThemableMixin) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.SplitLayout = void 0;

  var _templateObject_2ce16e20941811ec8d52c707f928eca0;
   ...
   */
  var SplitLayout = /*#__PURE__*/function (_ElementMixin) {
    babelHelpers.inherits(SplitLayout, _ElementMixin);

    var _super = _createSuper(SplitLayout);

    function SplitLayout() {
      babelHelpers.classCallCheck(this, SplitLayout);
      return _super.apply(this, arguments);
    }

    babelHelpers.createClass(SplitLayout, [{
      key: "ready",
      value:
      /** @protected */
      function ready() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(SplitLayout.prototype), "ready", this).call(this);
        this.__observer = new _flattenedNodesObserver.FlattenedNodesObserver(this, function (info) {
      ...
      value: function notifyResize() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(SplitLayout.prototype), "notifyResize", this).call(this);
      }
      /**
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_2ce16e20941811ec8d52c707f928eca0 || (_templateObject_2ce16e20941811ec8d52c707f928eca0 = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: flex;\n          overflow: hidden !important;\n          transform: translateZ(0);\n        }\n\n        :host([hidden]) {\n          display: none !important;\n        }\n\n        :host([orientation='vertical']) {\n          flex-direction: column;\n        }\n\n        :host ::slotted(*) {\n          flex: 1 1 auto;\n          overflow: auto;\n          -webkit-overflow-scrolling: touch;\n        }\n\n        [part='splitter'] {\n          flex: none;\n          position: relative;\n          z-index: 1;\n          overflow: visible;\n          min-width: 8px;\n          min-height: 8px;\n        }\n\n        :host(:not([orientation='vertical'])) > [part='splitter'] {\n          cursor: ew-resize;\n        }\n\n        :host([orientation='vertical']) > [part='splitter'] {\n          cursor: ns-resize;\n        }\n\n        [part='handle'] {\n          width: 40px;\n          height: 40px;\n          position: absolute;\n          top: 50%;\n          left: 50%;\n          transform: translate3d(-50%, -50%, 0);\n        }\n      </style>\n      <slot id=\"primary\" name=\"primary\"></slot>\n      <div\n        part=\"splitter\"\n        id=\"splitter\"\n        on-track=\"_onHandleTrack\"\n        on-down=\"_setPointerEventsNone\"\n        on-up=\"_restorePointerEvents\"\n      >\n        <div part=\"handle\"></div>\n      </div>\n      <slot id=\"secondary\" name=\"secondary\"></slot>\n    "])));
      }
    }, {
      key: "is",
      get: function get() {
    ...
    return SplitLayout;
  }((0, _elementMixin.ElementMixin)((0, _vaadinThemableMixin.ThemableMixin)((0, _gestureEventListeners.GestureEventListeners)((0, _class.mixinBehaviors)([_ironResizableBehavior.IronResizableBehavior], _polymerElement.PolymerElement)))));

  _exports.SplitLayout = SplitLayout;
