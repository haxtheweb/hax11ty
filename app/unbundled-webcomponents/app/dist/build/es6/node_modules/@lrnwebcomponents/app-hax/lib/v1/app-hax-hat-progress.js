import{html as e,css as s}from"../../../../lit/index.js";import{SimpleColors as r}from"../../../simple-colors/simple-colors.js";import{autorun as t,toJS as o}from"../../../../mobx/dist/mobx.esm.js";import{store as i}from"./AppHaxStore.js";import"../../../promise-progress/promise-progress.js";export class AppHaxHatProgress extends r{static get tag(){return"app-hax-hat-progress"}constructor(){super(),this.promises=[],this.max=100,t((()=>{this.promises=o(i.newSitePromiseList)})),t((()=>{this.dark=o(i.darkMode)}))}static get properties(){return{...super.properties,promises:{type:Array}}}process(){this.shadowRoot.querySelector("#progress2").process()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.dispatchEvent(new CustomEvent("progress-ready",{detail:!0})),setTimeout((()=>{this.shadowRoot.querySelector("#progress2").addEventListener("value-changed",(e=>{this.shadowRoot.querySelector("#value").textContent=e.detail.value})),this.shadowRoot.querySelector("#progress2").addEventListener("max-changed",(e=>{this.max=e.detail.value})),this.shadowRoot.querySelector("#progress2").addEventListener("promise-progress-finished",(e=>{if(e.detail.value){this.dispatchEvent(new CustomEvent("promise-progress-finished",{detail:!0}));const e=i.AppHaxAPI.lastResponse.createSite,s=document.createElement("button");this.shadowRoot.querySelector("#value").textContent=this.max,s.textContent="Let's go!",s.classList.add("game"),s.addEventListener("click",(()=>{window.location=o(i.sitesBase).concat(e.slug)})),this.shadowRoot.querySelector("#progress2").parentNode.appendChild(s),i.toast(`${e.title} looks awesome, come see!`,5e3,{hat:"random",walking:!0})}}))}),0)}static get styles(){return[...super.styles,s`
        :host {
          display: block;
          height: 400px;
          width: 400px;
