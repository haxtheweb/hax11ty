import{css as t,html as e,unsafeCSS as i}from"../../../../lit/index.js";import{SimpleToastEl as a}from"../../../simple-toast/lib/simple-toast-el.js";import"../../../rpg-character/rpg-character.js";const s=new URL("./images/SpeechBubbleL.svg",import.meta.url).href,l=new URL("./images/SpeechBubbleMiddle.svg",import.meta.url).href,r=new URL("./images/SpeechBubbleR.svg",import.meta.url).href;export class RPGCharacterToast extends a{static get tag(){return"rpg-character-toast"}constructor(){super(),this.setDefaultToast(),this.key=null,this.phrases={},this.fire=!1,this.hat="coffee",this.walking=!1,this.word=null,this.addEventListener("click",(()=>{this.opened=!1}))}static get styles(){return[...super.styles,t`
      :host([opened]) {
        display: block;
      }
