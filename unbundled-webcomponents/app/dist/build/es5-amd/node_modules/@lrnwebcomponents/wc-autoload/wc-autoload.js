define(["exports","../dynamic-import-registry/dynamic-import-registry.js"],function(_exports,_dynamicImportRegistry){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.WcAutoload=void 0;function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}// register globally so we can make sure there is only one
 ...
 * @element wc-autoload
 */var WcAutoload=/*#__PURE__*/function(_HTMLElement){babelHelpers.inherits(WcAutoload,_HTMLElement);var _super=_createSuper(WcAutoload);babelHelpers.createClass(WcAutoload,null,[{key:"tag",/**
   * This is a convention, not the standard
   */get:function get(){return"wc-autoload"}}]);function WcAutoload(){var _this;babelHelpers.classCallCheck(this,WcAutoload);_this=_super.call(this);_this.loaded=!1;_this.registry=window.DynamicImportRegistry.requestAvailability();_this.options={childList:!0,subtree:!0};return _this}babelHelpers.createClass(WcAutoload,[{key:"connectedCallback",value:function connectedCallback(){var _this2=this;// listen for changes and then process any new node that has a tag name
