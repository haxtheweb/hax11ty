 ...
 */var HAXCMSLitElementTheme=/*#__PURE__*/function(_HAXCMSTheme){babelHelpers.inherits(HAXCMSLitElementTheme,_HAXCMSTheme);var _super=_createSuper(HAXCMSLitElementTheme);function HAXCMSLitElementTheme(){var _this;babelHelpers.classCallCheck(this,HAXCMSLitElementTheme);_this=_super.call(this);_this.editMode=!1;_this.isLoggedIn=!1;return _this}babelHelpers.createClass(HAXCMSLitElementTheme,[{key:"firstUpdated",// LitElement life cycle
...
_this2.dispatchEvent(new CustomEvent("edit-mode-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:_this2[propName]}));_this2._editModeChanged(_this2[propName],oldValue)}})}}],[{key:"properties",get:function get(){return _objectSpread(_objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSLitElementTheme),"properties",this)),{},{/**
       * Class for the color
