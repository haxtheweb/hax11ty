define(["exports","../../../../lit-element/lit-element.js","./haxcms-site-store.js","../../../../mobx/lib/mobx.module.js","../../../json-outline-schema/json-outline-schema.js","../../../editable-outline/editable-outline.js","../../../../@polymer/paper-button/paper-button.js","../../../../@polymer/iron-icon/iron-icon.js","../../../../@polymer/iron-icons/iron-icons.js"],function(_exports,_litElement,_haxcmsSiteStore,_mobxModule,_jsonOutlineSchema,_editableOutline,_paperButton,_ironIcon,_ironIcons){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXCMSOutlineEditorDialog=void 0;function _templateObject2_db886110afde11eabe4cb3f9cdf860d1(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          height: 60vh;\n          min-width: 50vw;\n        }\n        .buttons {\n          position: absolute;\n          bottom: 0;\n          z-index: 1000000;\n          background-color: var(--simple-modal-titlebar-background, #000000);\n          color: var(--simple-modal-titlebar-color, #ffffff);\n          left: 0;\n          right: 0;\n        }\n        .buttons paper-button {\n          color: #ffffff;\n          background-color: var(--simple-modal-button-background, #000000);\n        }\n        editable-outline:not(:defined),\n        paper-button:not(:defined) {\n          display: none;\n        }\n        #toggle {\n          float: right;\n          text-transform: unset;\n        }\n        #savebtn {\n          color: white;\n          background-color: var(--haxcms-color, #2196f3);\n        }\n        editable-outline {\n          margin-bottom: 32px;\n        }\n      "]);_templateObject2_db886110afde11eabe4cb3f9cdf860d1=function _templateObject2_db886110afde11eabe4cb3f9cdf860d1(){return data};return data}function _templateObject_db886110afde11eabe4cb3f9cdf860d1(){var data=babelHelpers.taggedTemplateLiteral(["\n      <editable-outline\n        id=\"outline\"\n        edit-mode\n        .hidden=\"","\"\n        .items=\"","\"\n      ></editable-outline>\n      <div class=\"buttons\">\n        <paper-button id=\"savebtn\" dialog-confirm @click=\"","\"\n          ><iron-icon icon=\"icons:save\"></iron-icon>Save</paper-button\n        >\n        <paper-button dialog-dismiss\n          ><iron-icon icon=\"icons:cancel\"></iron-icon>Cancel</paper-button\n        >\n      </div>\n    "]);_templateObject_db886110afde11eabe4cb3f9cdf860d1=function _templateObject_db886110afde11eabe4cb3f9cdf860d1(){return data};return data}function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
 ...
 */var HAXCMSOutlineEditorDialog=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(HAXCMSOutlineEditorDialog,_LitElement);var _super=_createSuper(HAXCMSOutlineEditorDialog);babelHelpers.createClass(HAXCMSOutlineEditorDialog,[{key:"render",// render function
value:function render(){return(0,_litElement.html)(_templateObject_db886110afde11eabe4cb3f9cdf860d1(),this.viewMode,this.manifestItems,this._saveTap)}}],[{key:"styles",/**
   * LitElement constructable styles enhancement
   */get:function get(){return[(0,_litElement.css)(_templateObject2_db886110afde11eabe4cb3f9cdf860d1())]}/**
   * Store the tag name to make it easier to obtain directly.
   */},{key:"tag",get:function get(){return"haxcms-outline-editor-dialog"}}]);function HAXCMSOutlineEditorDialog(){var _this;babelHelpers.classCallCheck(this,HAXCMSOutlineEditorDialog);_this=_super.call(this);_this.__disposer=[];_this.viewMode=!1;return _this}babelHelpers.createClass(HAXCMSOutlineEditorDialog,[{key:"updated",/**
   * LitElement property change life cycle
   */value:function updated(changedProperties){var _this2=this;changedProperties.forEach(function(oldValue,propName){if("opened"==propName){// notify
...
_this2.dispatchEvent(new CustomEvent("manifest-edit-mode-changed",{detail:_this2[propName]}))}})}},{key:"_manifestItemsChanged",value:function _manifestItemsChanged(newValue){if(newValue){window.JSONOutlineSchema.requestAvailability().items=newValue;this.manifestItemsStatic=JSON.stringify(newValue,null,2)}}},{key:"firstUpdated",value:function firstUpdated(){this.shadowRoot.querySelector("#outline").importJsonOutlineSchemaItems()}},{key:"connectedCallback",value:function connectedCallback(){var _this3=this;babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSOutlineEditorDialog.prototype),"connectedCallback",this).call(this);(0,_mobxModule.autorun)(function(reaction){_this3.manifestItems=babelHelpers.toConsumableArray((0,_mobxModule.toJS)(_haxcmsSiteStore.store.manifest.items));_this3.__disposer.push(reaction)})}/**
   * detached life cycle
