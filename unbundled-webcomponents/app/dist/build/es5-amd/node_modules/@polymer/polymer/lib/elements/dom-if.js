define(["exports","../../polymer-element.js","../utils/debounce.js","../utils/flush.js","../utils/async.js","../utils/path.js","../utils/wrap.js","../utils/hide-template-controls.js","../utils/settings.js","../utils/templatize.js"],function(_exports,_polymerElement,_debounce,_flush,_async,_path,_wrap,_hideTemplateControls,_settings,_templatize){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.DomIf=void 0;function _createSuper(Derived){var hasNativeReflectConstruct=_isNativeReflectConstruct();return function _createSuperInternal(){var Super=babelHelpers.getPrototypeOf(Derived),result;if(hasNativeReflectConstruct){var NewTarget=babelHelpers.getPrototypeOf(this).constructor;result=Reflect.construct(Super,arguments,NewTarget)}else{result=Super.apply(this,arguments)}return babelHelpers.possibleConstructorReturn(this,result)}}function _isNativeReflectConstruct(){if("undefined"===typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"===typeof Proxy)return!0;try{Date.prototype.toString.call(Reflect.construct(Date,[],function(){}));return!0}catch(e){return!1}}/**
 * @customElement
 * @polymer
 * @extends PolymerElement
 * @summary Base class for dom-if element; subclassed into concrete
 *   implementation.
 */var DomIfBase=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(DomIfBase,_PolymerElement);var _super=_createSuper(DomIfBase);babelHelpers.createClass(DomIfBase,null,[{key:"is",// Not needed to find template; can be removed once the analyzer
...
this.__instance=host._stampTemplate(/** @type {!HTMLTemplateElement} */this.__template,templateInfo);(0,_wrap.wrap)(parentNode).insertBefore(this.__instance,this)}/**
   ...
   * @protected
   * @suppress {visibility}
   */},{key:"_showHideChildren",value:function _showHideChildren(){var hidden=this.__hideTemplateChildren__||!this.if;if(this.__instance&&!!this.__instance.__hidden!==hidden){this.__instance.__hidden=hidden;(0,_templatize.showHideChildren)(hidden,this.__instance.templateInfo.childNodes)}if(!hidden){this.__syncHostProperties()}}}]);return DomIfFast}(DomIfBase),DomIfLegacy=/*#__PURE__*/function(_DomIfBase2){babelHelpers.inherits(DomIfLegacy,_DomIfBase2);var _super3=_createSuper(DomIfLegacy);function DomIfLegacy(){var _this6;babelHelpers.classCallCheck(this,DomIfLegacy);_this6=_super3.call(this);_this6.__ctor=null;_this6.__instance=null;_this6.__invalidProps=null;return _this6}/**
   * Implementation of abstract API needed by DomIfBase.
   *
   * @override
   * @return {boolean} True when an instance has been created.
