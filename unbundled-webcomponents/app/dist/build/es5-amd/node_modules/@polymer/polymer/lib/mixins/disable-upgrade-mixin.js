 ...
 */var DisableUpgradeMixin=(0,_mixin.dedupingMixin)(function(base){/**
   ...
   * @extends {HTMLElement}
   * @private
   */var superClass=(0,_elementMixin.ElementMixin)(base),observedAttributesGetter=findObservedAttributesGetter(superClass),DisableUpgradeClass=/*#__PURE__*/function(_superClass){babelHelpers.inherits(DisableUpgradeClass,_superClass);var _super=_createSuper(DisableUpgradeClass);function DisableUpgradeClass(){var _this;babelHelpers.classCallCheck(this,DisableUpgradeClass);_this=_super.call(this);/** @type {boolean|undefined} */_this.__isUpgradeDisabled;return _this}babelHelpers.createClass(DisableUpgradeClass,[{key:"_initializeProperties",// Prevent element from initializing properties when it's upgrade disabled.
