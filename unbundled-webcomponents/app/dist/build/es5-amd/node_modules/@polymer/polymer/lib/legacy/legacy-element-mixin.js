...
/**
   ...
   * @extends {HTMLElement}
   * @private
   */var GesturesElement=(0,_gestureEventListeners.GestureEventListeners)((0,_elementMixin.ElementMixin)(base)),legacyElementBase=_elementMixin.builtCSS?GesturesElement:(0,_dirMixin.DirMixin)(GesturesElement),observedAttributesGetter=(0,_disableUpgradeMixin.findObservedAttributesGetter)(legacyElementBase),DIRECTION_MAP={x:"pan-x",y:"pan-y",none:"none",all:"auto"},LegacyElement=/*#__PURE__*/function(_legacyElementBase){babelHelpers.inherits(LegacyElement,_legacyElementBase);var _super=_createSuper(LegacyElement);function LegacyElement(){var _this;babelHelpers.classCallCheck(this,LegacyElement);_this=_super.call(this);/** @type {boolean} */_this.isAttached;/** @type {?WeakMap<!Element, !Object<string, !Function>>} */_this.__boundListeners;/** @type {?Object<string, ?Function>} */_this._debouncers;// NOTE: Inlined for perf from version of DisableUpgradeMixin.
