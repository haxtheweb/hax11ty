 ...
 */var ArraySelectorMixin=(0,_mixin.dedupingMixin)(function(superClass){/**
   ...
   * @private
   */var elementBase=(0,_elementMixin.ElementMixin)(superClass),ArraySelectorMixin=/*#__PURE__*/function(_elementBase){babelHelpers.inherits(ArraySelectorMixin,_elementBase);var _super=_createSuper(ArraySelectorMixin);babelHelpers.createClass(ArraySelectorMixin,null,[{key:"properties",get:function get(){return{/**
 ...
 * @implements {Polymer_ArraySelectorMixin}
 * @private
 */var baseArraySelector=ArraySelectorMixin(_polymerElement.PolymerElement),ArraySelector=/*#__PURE__*/function(_baseArraySelector){babelHelpers.inherits(ArraySelector,_baseArraySelector);var _super2=_createSuper(ArraySelector);function ArraySelector(){babelHelpers.classCallCheck(this,ArraySelector);return _super2.apply(this,arguments)}babelHelpers.createClass(ArraySelector,null,[{key:"is",// Not needed to find template; can be removed once the analyzer
