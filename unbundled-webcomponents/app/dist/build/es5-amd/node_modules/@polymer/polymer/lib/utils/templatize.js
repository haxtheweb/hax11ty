 ...
 * @unrestricted
 */var TemplateInstanceBase=/*#__PURE__*/function(_templateInstanceBase){babelHelpers.inherits(TemplateInstanceBase,_templateInstanceBase);var _super=_createSuper(TemplateInstanceBase);function TemplateInstanceBase(props){var _this;babelHelpers.classCallCheck(this,TemplateInstanceBase);_this=_super.call(this);_this._configureProperties(props);/** @type {!StampedTemplate} */_this.root=_this._stampTemplate(_this.__dataHost);// Save list of stamped children
...
if(templatize.mixin){templatizerBase=templatize.mixin(templatizerBase)}/**
   ...
   * @constructor
   * @private
   */var klass=/*#__PURE__*/function(_templatizerBase){babelHelpers.inherits(klass,_templatizerBase);var _super2=_createSuper(klass);function klass(){babelHelpers.classCallCheck(this,klass);return _super2.apply(this,arguments)}return klass}(templatizerBase);/** @override */klass.prototype.__templatizeOptions=options;klass.prototype._bindTemplate(template);addNotifyEffects(klass,template,templateInfo,options);return klass}/**
...
if(!klass){if(isTemplate){/**
         * @constructor
         * @extends {DataTemplate}
         */var templatizedBase=options.mutableData?MutableDataTemplate:DataTemplate,TemplatizedTemplate=/*#__PURE__*/function(_templatizedBase){babelHelpers.inherits(TemplatizedTemplate,_templatizedBase);var _super3=_createSuper(TemplatizedTemplate);function TemplatizedTemplate(){babelHelpers.classCallCheck(this,TemplatizedTemplate);return _super3.apply(this,arguments)}return TemplatizedTemplate}(templatizedBase);// NOTE: due to https://github.com/google/closure-compiler/issues/2928,
// combining the next two lines into one assignment causes a spurious
// type error.
/** @private */klass=templateInfo.templatizeTemplateClass=TemplatizedTemplate}else{/**
         * @constructor
         * @extends {PolymerElement}
         */var _templatizedBase2=target.constructor,TemplatizedTemplateExtension=/*#__PURE__*/function(_templatizedBase3){babelHelpers.inherits(TemplatizedTemplateExtension,_templatizedBase3);var _super4=_createSuper(TemplatizedTemplateExtension);function TemplatizedTemplateExtension(){babelHelpers.classCallCheck(this,TemplatizedTemplateExtension);return _super4.apply(this,arguments)}return TemplatizedTemplateExtension}(_templatizedBase2);// Create a cached subclass of the base custom element class onto which
...
/** @private */var klass=/*#__PURE__*/function(_baseClass){babelHelpers.inherits(TemplateInstance,_baseClass);var _super5=_createSuper(TemplateInstance);function TemplateInstance(){babelHelpers.classCallCheck(this,TemplateInstance);return _super5.apply(this,arguments)}return TemplateInstance}(baseClass);/** @override */klass.prototype._methodHost=methodHost;/** @override */klass.prototype.__dataHost=/** @type {!DataTemplate} */template;/** @override */klass.prototype.__templatizeOwner=/** @type {!Object} */owner;/** @override */klass.prototype.__hostProps=templateInfo.hostProps;klass=/** @type {function(new:TemplateInstanceBase)} */klass;//eslint-disable-line no-self-assign
