 ...
 */var Router=/*#__PURE__*/function(_Resolver){babelHelpers.inherits(Router,_Resolver);var _super=_createSuper(Router);/**
   ...
   */function Router(outlet,options){var _this2;babelHelpers.classCallCheck(this,Router);var baseElement=document.head.querySelector("base"),baseHref=baseElement&&baseElement.getAttribute("href");_this2=_super.call(this,[],Object.assign({// Default options
...
try {
  ...
  vaadin-dev-mode:end **/}var usageStatistics=function usageStatistics(){if("function"===typeof runIfDevelopmentMode){return runIfDevelopmentMode(maybeGatherAndSendStats)}};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.2"});usageStatistics();Router.NavigationTrigger={POPSTATE:POPSTATE,CLICK:CLICK}});