define(["exports","require","../../lit-element/lit-element.js","../haxcms-elements/lib/core/HAXCMSLitElementTheme.js","../../@polymer/app-layout/app-drawer/app-drawer.js","../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js","../haxcms-elements/lib/ui-components/active-item/site-active-title.js","../haxcms-elements/lib/ui-components/site/site-title.js","../haxcms-elements/lib/ui-components/navigation/site-menu.js","../../@polymer/polymer/lib/elements/custom-style.js"],(function(_exports,_require,_litElement,_HAXCMSLitElementTheme,_appDrawer,_appDrawerLayout,_siteActiveTitle,_siteTitle,_siteMenu,_customStyle){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LearnTwoTheme=void 0,_require=babelHelpers.interopRequireWildcard(_require);
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class LearnTwoTheme extends _HAXCMSLitElementTheme.HAXCMSLitElementTheme{static get styles(){return[_litElement.css`
        :host {
    ...
    `}static get properties(){return{...super.properties}}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,setTimeout(()=>{new Promise((res,rej)=>_require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-rss-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-print-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/layout/site-modal.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"],res,rej))},0)}siteModalClick(e){new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-search.js"],res,rej))}static get tag(){return"learn-two-theme"}static get properties(){return{...super.properties,opened:{type:Boolean,reflect:!0}}}__openedChanged(e){this.opened=e.detail.value}toggleDrawer(e){this.shadowRoot.querySelector("app-drawer").toggle()}}_exports.LearnTwoTheme=LearnTwoTheme,window.customElements.define(LearnTwoTheme.tag,LearnTwoTheme)}));