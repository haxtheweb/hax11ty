define(["exports","require","../../../../../lit-element/lit-element.js","../../../../simple-fields/lib/simple-fields-field.js","../../../../../@polymer/iron-icons/iron-icons.js","../../../../../@polymer/iron-icon/iron-icon.js"],(function(_exports,_require,_litElement,_simpleFieldsField,_ironIcons,_ironIcon){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SiteSearch=void 0,_require=babelHelpers.interopRequireWildcard(_require);
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class SiteSearch extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
          font-size: 16px;
      ...
      `]}static get tag(){return"site-search"}constructor(){super(),this.search="",this.__results=[],setTimeout(()=>{new Promise((res,rej)=>_require.default(["../../../../lunr-search/lunr-search.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../../simple-datetime/simple-datetime.js"],res,rej))},0)}render(){return _litElement.html`
      <simple-fields-field
        id="search"
        always-float-label
        label="Search"
