define(["exports","../../../../lit-element/lit-element.js","./haxcms-site-store.js","../../../utils/utils.js","../../../../mobx/lib/mobx.module.js","../../../../@polymer/paper-button/paper-button.js","../../../../@polymer/paper-icon-button/paper-icon-button.js","../../../simple-tooltip/simple-tooltip.js","../../../../@polymer/iron-icons/iron-icons.js","../../../../@polymer/iron-icons/notification-icons.js","../../../simple-fields/lib/simple-fields-form.js","../../../portal-launcher/portal-launcher.js","../../../hax-body-behaviors/lib/HAXFields.js"],(function(_exports,_litElement,_haxcmsSiteStore,_utils,_mobxModule,_paperButton,_paperIconButton,_simpleTooltip,_ironIcons,_notificationIcons,_simpleFieldsForm,_portalLauncher,_HAXFields){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HAXCMSSiteDashboard=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class HAXCMSSiteDashboard extends _litElement.LitElement{static get tag(){return"haxcms-site-dashboard"}constructor(){super(),this.manifest={},this.__disposer=[],(0,_mobxModule.autorun)(reaction=>{this.jwt=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.jwt),this.__disposer.push(reaction)}),(0,_mobxModule.autorun)(reaction=>{this.dashboardOpened=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.dashboardOpened),this.__disposer.push(reaction)}),(0,_mobxModule.autorun)(reaction=>{this.manifest=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.manifest),this.__disposer.push(reaction)})}static get styles(){return[_litElement.css`
        :host {
          z-index: 1;
      ...
      <div class="title-wrapper">
        ...
        ${(0,_utils.varExists)(this.manifest,"metadata.site.static.publishedLocation")?_litElement.html`
              <span class="toptext">
                <a
                  class="publishlink"
    ...
    `}static get properties(){return{dashboardOpened:{type:Boolean,reflect:!0,attribute:"dashboard-opened"},method:{type:String},jwt:{type:String},publishing:{type:Boolean},manifest:{type:Object}}}disconnectedCallback(){for(var i in this.__disposer)this.__disposer[i].dispose();super.disconnectedCallback()}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"dashboardOpened"===propName&&this.dashboardOpened&&(this.removeAttribute("aria-hidden"),this.removeAttribute("tabindex")),"dashboardOpened"!==propName||this.dashboardOpened||(this.setAttribute("aria-hidden","aria-hidden"),this.setAttribute("tabindex","-1"))})}_saveSiteFieldsTap(e){window.dispatchEvent(new CustomEvent("haxcms-save-site-data",{bubbles:!0,composed:!0,cancelable:!0,detail:this.shadowRoot.querySelector("#siteform").submit()}))}_cancel(e){window.dispatchEvent(new CustomEvent("haxcms-load-site-dashboard",{bubbles:!0,composed:!0,cancelable:!1,detail:e.target}))}}_exports.HAXCMSSiteDashboard=HAXCMSSiteDashboard,window.customElements.define(HAXCMSSiteDashboard.tag,HAXCMSSiteDashboard)}));