define(["../polymer/polymer-legacy.js", "../paper-styles/typography.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/utils/html-tag.js", "./paper-input-addon-behavior.js"], function (_polymerLegacy, _typography, _polymerFn, _htmlTag, _paperInputAddonBehavior) {
  ...
  function _templateObject_f5ce76b0aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n        float: right;\n\n        @apply --paper-font-caption;\n        @apply --paper-input-char-counter;\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      :host(:dir(rtl)) {\n        float: left;\n      }\n    </style>\n\n    <span>[[_charCounterStr]]</span>\n"]);

    _templateObject_f5ce76b0aa9111ea8481a12db8bed9e6 = function _templateObject_f5ce76b0aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    /** @override */
    _template: (0, _htmlTag.html)(_templateObject_f5ce76b0aa9111ea8481a12db8bed9e6()),
