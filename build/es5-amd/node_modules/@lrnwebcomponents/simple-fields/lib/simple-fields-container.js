define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject10_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot name=\"suffix\"></slot>\n      ", "\n    "]);

    _templateObject10_10573800aa9211ea8481a12db8bed9e6 = function _templateObject10_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject9_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot name=\"prefix\"></slot>\n      ", "\n    "]);

    _templateObject9_10573800aa9211ea8481a12db8bed9e6 = function _templateObject9_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject8_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <label\n        for=\"", "\"\n        class=\"label-main\"\n        ?hidden=\"", "\"\n      >\n        <slot name=\"label\"></slot>\n        ", "", "\n      </label>\n    "]);

    _templateObject8_10573800aa9211ea8481a12db8bed9e6 = function _templateObject8_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject7_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"fieldmeta\" aria-live=\"polite\">\n        <slot name=\"field-meta\"></slot>\n      </div>\n    "]);

    _templateObject7_10573800aa9211ea8481a12db8bed9e6 = function _templateObject7_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject6_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div\n        class=\"", "\"\n      >\n        ", "\n        <div>\n          ", "\n          <slot name=\"field\"></slot>\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject6_10573800aa9211ea8481a12db8bed9e6 = function _templateObject6_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject5_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"border-bottom blur\"></div>\n      <div class=\"border-bottom focus\"></div>\n      <div id=\"field-bottom\">\n        <div id=\"error-desc\">\n          ", " ", "\n        </div>\n        ", "\n      </div>\n    "]);

    _templateObject5_10573800aa9211ea8481a12db8bed9e6 = function _templateObject5_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject4_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"error-message\" ?hidden=\"", "\" role=\"alert\">\n        ", "\n      </div>\n    "]);

    _templateObject4_10573800aa9211ea8481a12db8bed9e6 = function _templateObject4_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject3_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"description\">\n        <slot name=\"description\"></slot>\n        ", "\n      </div>\n    "]);

    _templateObject3_10573800aa9211ea8481a12db8bed9e6 = function _templateObject3_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject2_10573800aa9211ea8481a12db8bed9e6() {
    ...
    _templateObject2_10573800aa9211ea8481a12db8bed9e6 = function _templateObject2_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_10573800aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", " ", "\n    "]);

    _templateObject_10573800aa9211ea8481a12db8bed9e6 = function _templateObject_10573800aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(SimpleFieldsContainer, _LitElement);
    babelHelpers.createClass(SimpleFieldsContainer, [{
      key: "render",
      value: function render() {
        return (0, _litElement.html)(_templateObject_10573800aa9211ea8481a12db8bed9e6(), this.fieldMainTemplate, this.fieldBottom);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_10573800aa9211ea8481a12db8bed9e6())];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    function SimpleFieldsContainer() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleFieldsContainer).call(this));
      _this.counter = "none";
    ...
    babelHelpers.createClass(SimpleFieldsContainer, [{
      ...
      value: function disconnectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsContainer.prototype), "disconnectedCallback", this).call(this);
      }
      /**
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "error" && _this3.error !== oldValue) errorChanged = true;
          if (propName === "errorMessage" && _this3.errorMessage !== oldValue) errorChanged = true;

          if (propName === "error" && _this3.field) {
            _this3.field.setAttribute("aria-invalid", _this3.error ? "true" : "false");
          }
        });
      ...
      value: function _updateField() {
        ...
        if (this.field) {
          ...
          if (oldfield) {
            ...
            oldfield.removeEventListener("change", function (e) {
              return _this5._handleFieldChange();
            });
            oldfield.removeEventListener("input", function (e) {
              return _this5._handleFieldChange();
            });
          }
        }
      ...
      value: function _updateCount() {
        ...
        var count = "",
          ...
          return !_this6.field.value ? 0 : _this6.field.value.length;
        },
            wordlength = function wordlength() {
          return !_this6.field.value || !_this6.field.value.match(wordcounter) ? 0 : _this6.field.value.match(wordcounter).length;
        },
            correctLength = function correctLength(length, max, regex) {
          if (length && max && max < length && _this6.field.value.match(regex)) {
            _this6.field.value = _this6.field.value.match(regex)[0].trim();
          }
        };
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject3_10573800aa9211ea8481a12db8bed9e6(), this.description);
      }
      /**
      ...
      key: "errorTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject4_10573800aa9211ea8481a12db8bed9e6(), !this.error, this.errorMessage);
      }
      /**
       *
      ...
      key: "fieldBottom",
      get: function get() {
        return (0, _litElement.html)(_templateObject5_10573800aa9211ea8481a12db8bed9e6(), this.descriptionTemplate, this.errorTemplate, this.fieldMeta);
      }
      /**
       * gets field's id
       *
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject6_10573800aa9211ea8481a12db8bed9e6(), this.inline || ["checkbox", "color", "radio"].includes(this.type || "text") ? "field-main inline" : "field-main", this.labelTemplate, this.prefixTemplate, this.suffixTemplate);
      }
      /**
       *
       * gets field metadata
      ...
      key: "fieldMeta",
      get: function get() {
        return (0, _litElement.html)(_templateObject7_10573800aa9211ea8481a12db8bed9e6());
      }
      /**
       * template for slotted or shadow DOM label
       *
      ...
      key: "labelTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject8_10573800aa9211ea8481a12db8bed9e6(), this.fieldId, this.type === "fieldset", this.label, this.error || this.required ? "*" : "");
      }
      /**
      ...
      key: "numberError",
      get: function get() {
        var multicheck = this.type === "fieldset" && this.field.querySelector("input[type=checkbox]"),
      ...
      get: function get() {
        ...
        return this.pattern && this.pattern !== "" && this._getFieldValue() && (!this.field.multiple ? !this._getFieldValue().match(this.pattern) : this._getFieldValue().filter(function (value) {
          return !value.match(_this7.pattern);
        }));
      }
      /**
      ...
      key: "prefixTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject9_10573800aa9211ea8481a12db8bed9e6(), this.prefix);
      }
      /**
      ...
      key: "suffixTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject10_10573800aa9211ea8481a12db8bed9e6(), this.suffix);
      }
    }]);
