define(["exports", "meta", "../../lit-element/lit-element.js", "../utils/utils.js", "../es-global-bridge/es-global-bridge.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, meta, _litElement, _utils, _esGlobalBridge, _ironAjax) {
  ...
  function _templateObject3_f6ef7710aa9111ea8481a12db8bed9e6() {
    ...
    _templateObject3_f6ef7710aa9111ea8481a12db8bed9e6 = function _templateObject3_f6ef7710aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject2_f6ef7710aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <iron-ajax\n                auto\n                handle-as=\"text\"\n                url=\"", "\"\n                @response=\"", "\"\n              ></iron-ajax>\n            "]);

    _templateObject2_f6ef7710aa9111ea8481a12db8bed9e6 = function _templateObject2_f6ef7710aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_f6ef7710aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <div id=\"", "-title\" class=\"title\">\n          ", "\n          <slot name=\"heading\"></slot>\n        </div>\n        <div id=\"", "-desc\" class=\"desc\">\n          ", "\n          <slot name=\"desc\"></slot>\n        </div>\n        <div\n          id=\"chart\"\n          chart=\"", "\"\n          role=\"presentation\"\n          aria-labelledby=\"", "-title\"\n          aria-describedby=\"", "-table ", "-desc\"\n          class=\"ct-chart ", "\"\n        ></div>\n        <div\n          id=\"", "-table\"\n          class=\"", "\"\n        >\n          <slot></slot>\n        </div>\n        ", "\n      "]);

    _templateObject_f6ef7710aa9111ea8481a12db8bed9e6 = function _templateObject_f6ef7710aa9111ea8481a12db8bed9e6() {
      return data;
    };
      ...
      function (_SuperClass) {
        ...
        babelHelpers.createClass(_class, [{
          ...
          value: function render() {
            return (0, _litElement.html)(_templateObject_f6ef7710aa9111ea8481a12db8bed9e6(), this.__chartId, this.chartTitle, this.__chartId, this.chartDesc, this.__chartId, this.__chartId, this.__chartId, this.__chartId, this.scale, this.__chartId, this.showTable ? "table" : "table sr-only", this.dataSource != "" ? (0, _litElement.html)(_templateObject2_f6ef7710aa9111ea8481a12db8bed9e6(), this.dataSource, this._handleResponse) : "");
          ...
          //styles function
          get: function get() {
            return [(0, _litElement.css)(_templateObject3_f6ef7710aa9111ea8481a12db8bed9e6())];
          }
        }, {
          key: "properties",
          get: function get() {
        ...
        babelHelpers.createClass(_class, [{
          ...
          value: function updated(changedProperties) {
            ...
            changedProperties.forEach(function (oldValue, propName) {
              if (propName === "chartData" && JSON.stringify(_this2.chartData) !== JSON.stringify(oldValue)) {
                /**
                 * Fires when chartData changes
                 * @event chart-data-changed
                 */
                _this2.dispatchEvent(new CustomEvent("chart-data-changed", {
                  detail: _this2
                }));

                _this2._getChart();
              } else if (propName === "dataSource" && _this2.dataSource !== oldValue) {
                /**
                 * Fires when data-source changes
                 * @event data-source-changed
                 */
                _this2.dispatchEvent(new CustomEvent("data-source-changed", {
                  detail: _this2
                }));
              } else if (propName === "data" && JSON.stringify(_this2.data) !== JSON.stringify(oldValue)) {
                /**
                 * Fires when data changes
                 * @event data-changed
                 */
                _this2.dispatchEvent(new CustomEvent("data-changed", {
                  detail: _this2
                }));

                _this2._renderTable();

                _this2._updateChartData();
              } else {
                _this2._getChart();
              }
            });
          ...
          value: function disconnectedCallback() {
            ...
            this.plugins.forEach(function (plugin) {
              return window.removeEventListener("es-bridge-".concat(plugin[0], "-loaded"), _this3._getChart.bind(_this3));
            });
          ...
          value: function _chartistLoaded() {
            ...
            this.plugins.forEach(function (plugin) {
              return _this4._loadScripts(plugin[0], plugin[1]);
            });
          }
          /**
          ...
          value: function _getChart() {
            ...
            if (target !== null && (typeof Chartist === "undefined" ? "undefined" : babelHelpers.typeof(Chartist)) === "object" && this.chartData) {
              if (this.type == "bar") {
              ...
              if (chart) {
                chart.on("created", function (e) {
                   ...
                   *
                   */
                  _this5.dispatchEvent(new CustomEvent("chartist-render-created", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: e
                ...
                chart.on("draw", function (e) {
                   ...
                   *
                   */
                  _this5.dispatchEvent(new CustomEvent("chartist-render-draw", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: e
          ...
          key: "_handleResponse",
          value: function _handleResponse(e) {
          ...
          value: function _loadScripts(classname, path) {
            ...
            var basePath = this.pathFromUrl(decodeURIComponent(meta.url)),
                location = "".concat(basePath).concat(path);
          ...
          value: function _renderTable() {
            var html = "",
                ...
                data = this.data ? babelHelpers.toConsumableArray(this.data) : false;
            ...
            if (data) {
              var rowHeads = data[1] && data[1][0] && isNaN(data[1][0]),
                ...
                col: rowHeads ? data[0].slice(1, data[0].length) : data[0]
                  ...
                  tbody = data.slice(thead ? 1 : 0, data.length).map(function (row) {
                return rowHeads ? {
                  th: row[0],
  ...
  function (_ChartistRenderSuper) {
    ...
    function ChartistRender() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ChartistRender).apply(this, arguments));
    }

    return ChartistRender;
  }(ChartistRenderSuper(_litElement.LitElement));
