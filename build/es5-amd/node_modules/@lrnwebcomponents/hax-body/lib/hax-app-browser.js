define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "./hax-tray-button.js"], function (_exports, _require, _litElement, _utils, _haxTrayButton) {
  ...
  function _templateObject3_0af866e0aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_0af866e0aa9211ea8481a12db8bed9e6 = function _templateObject3_0af866e0aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject2_0af866e0aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"item-wrapper\">\n        ", "\n      </div>\n      <hax-app-search\n        id=\"haxappsearch\"\n        .hidden=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "]);

    _templateObject2_0af866e0aa9211ea8481a12db8bed9e6 = function _templateObject2_0af866e0aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_0af866e0aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host *[hidden] {\n          display: none;\n        }\n        .toolbar-inner {\n          display: block;\n          padding: 0;\n          width: 100%;\n        }\n        .item-wrapper {\n          text-align: center;\n        }\n      "]);

    _templateObject_0af866e0aa9211ea8481a12db8bed9e6 = function _templateObject_0af866e0aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_0af866e0aa9211ea8481a12db8bed9e6())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_0af866e0aa9211ea8481a12db8bed9e6(), this.appList.map(function (app) {
          return (0, _litElement.html)(_templateObject3_0af866e0aa9211ea8481a12db8bed9e6(), app.index, app.details.title, app.details.icon, app.details.color, app.index);
        }), !this.searching);
      }
    }, {
      key: "firstUpdated",
