define(["exports", "../../lit-element/lit-element.js", "./lib/absolute-position-state-manager.js"], function (_exports, _litElement, _absolutePositionStateManager) {
  ...
  function _templateObject2_f7364410aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n          z-index: 99999999;\n          position: absolute;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      "]);

    _templateObject2_f7364410aa9111ea8481a12db8bed9e6 = function _templateObject2_f7364410aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_f7364410aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);

    _templateObject_f7364410aa9111ea8481a12db8bed9e6 = function _templateObject_f7364410aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(AbsolutePositionBehavior, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_f7364410aa9111ea8481a12db8bed9e6());
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_f7364410aa9111ea8481a12db8bed9e6())];
      }
    }, {
      key: "properties",
      get: function get() {
