define(["exports", "../../lit-element/lit-element.js", "../cms-hax/cms-hax.js"], function (_exports, _litElement, _cmsHax) {
  ...
  function _templateObject2_09640b40aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

    _templateObject2_09640b40aa9211ea8481a12db8bed9e6 = function _templateObject2_09640b40aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_09640b40aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <textarea\n        class=\"", "\"\n        id=\"", "\"\n        name=\"", "\"\n        hidden=\"\"\n      >\n      ", "\n      </textarea\n      >\n      <cms-hax\n        hide-message=\"\"\n        redirect-location=\"", "\"\n        update-page-data=\"", "\"\n        .end-point=\"", "\"\n        app-store-connection=\"", "\"\n        offset-margin=\"", "\"\n        ?open-default=\"", "\"\n        ?sync-body=\"", "\"\n        ?hide-panel-ops=\"", "\"\n        ?hide-preferences-button=\"", "\"\n        element-align=\"", "\"\n      >\n      </cms-hax>\n    "]);

    _templateObject_09640b40aa9211ea8481a12db8bed9e6 = function _templateObject_09640b40aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(WysiwygHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_09640b40aa9211ea8481a12db8bed9e6(), this.fieldClass, this.fieldId, this.fieldName, this.bodyValue, this.redirectLocation, this.updatePageData, this.endPoint, this.appStoreConnection, this.offsetMargin, this.openDefault, this.syncBody, this.hidePanelOps, this.hidePreferencesButton, this.elementAlign);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_09640b40aa9211ea8481a12db8bed9e6())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(WysiwygHax, [{
      ...
      key: "__saveClicked",
      value: function __saveClicked(e) {
      ...
      value: function _bodyContentUpdated(e) {
        ...
        this.bodyValue = window.HaxStore.instance.activeHaxBody.haxToContent();
        setTimeout(function () {
          if (_this3.saveButtonSelector) {
            _this3.saveButtonSelector.click();
          }
        }, 100);
      }
    }], [{
