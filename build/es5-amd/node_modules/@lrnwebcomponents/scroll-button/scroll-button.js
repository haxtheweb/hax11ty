define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _customStyle) {
  ...
  function _templateObject2_ec334080a61411ea914e9d138bd659c1() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          --scroll-button-z-index: 99;\n          z-index: var(--scroll-button-z-index);\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n        paper-icon-button {\n          background-color: rgba(0, 0, 0, 0.6);\n          color: white;\n        }\n        paper-icon-button:hover,\n        paper-icon-button:active,\n        paper-icon-button:focus {\n          background-color: rgba(0, 0, 0, 1);\n        }\n        simple-tooltip {\n          --simple-tooltip-background: #000000;\n          --simple-tooltip-opacity: 1;\n          --simple-tooltip-text-color: #ffffff;\n          --simple-tooltip-delay-in: 0;\n          --simple-tooltip-border-radius: 0;\n        }\n      "]);

    _templateObject2_ec334080a61411ea914e9d138bd659c1 = function _templateObject2_ec334080a61411ea914e9d138bd659c1() {
      return data;
    };
  ...
  function _templateObject_ec334080a61411ea914e9d138bd659c1() {
    ...
    _templateObject_ec334080a61411ea914e9d138bd659c1 = function _templateObject_ec334080a61411ea914e9d138bd659c1() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ScrollButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ec334080a61411ea914e9d138bd659c1(), this.scrollEvent, this.icon, this.label, this.position, this.label);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_ec334080a61411ea914e9d138bd659c1())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
