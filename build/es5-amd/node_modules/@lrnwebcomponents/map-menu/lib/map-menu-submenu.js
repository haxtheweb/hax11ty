define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_0d2ab030aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <map-menu-header\n        .avatar-label=\"", "\"\n        id=\"", "\"\n        title=\"", "\"\n        label=\"", "\"\n        ?opened=\"", "\"\n        url=\"", "\"\n        icon=\"", "\"\n        selected=\"", "\"\n      ></map-menu-header>\n      <iron-collapse id=\"container\"> <slot></slot> </iron-collapse>\n    "]);

    _templateObject2_0d2ab030aa9211ea8481a12db8bed9e6 = function _templateObject2_0d2ab030aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_0d2ab030aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([collapsable]) > map-menu-header {\n          cursor: pointer;\n          display: block;\n        }\n        #container {\n          margin-left: 16px;\n        }\n        #container ::slotted(map-menu-item) {\n          margin-top: 0.4em;\n        }\n      "]);

    _templateObject_0d2ab030aa9211ea8481a12db8bed9e6 = function _templateObject_0d2ab030aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuSubmenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_0d2ab030aa9211ea8481a12db8bed9e6())];
      }
    }]);
    ...
    babelHelpers.createClass(MapMenuSubmenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_0d2ab030aa9211ea8481a12db8bed9e6(), this.avatarLabel, this.id, this.title, this.label, this.opened, this.url, this.icon, this.selected);
      }
    }, {
      key: "updated",
