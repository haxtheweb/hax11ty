define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../utils/utils.js", "../anchor-behaviors/anchor-behaviors.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxModule, _utils, _anchorBehaviors) {
  ...
  function _templateObject5_fd3cedf0aa9111ea8481a12db8bed9e6() {
    ...
    _templateObject5_fd3cedf0aa9111ea8481a12db8bed9e6 = function _templateObject5_fd3cedf0aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject4_fd3cedf0aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject4_fd3cedf0aa9111ea8481a12db8bed9e6 = function _templateObject4_fd3cedf0aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject3_fd3cedf0aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject3_fd3cedf0aa9111ea8481a12db8bed9e6 = function _templateObject3_fd3cedf0aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject2_fd3cedf0aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"large\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject2_fd3cedf0aa9111ea8481a12db8bed9e6 = function _templateObject2_fd3cedf0aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_fd3cedf0aa9111ea8481a12db8bed9e6() {
    ...
    _templateObject_fd3cedf0aa9111ea8481a12db8bed9e6 = function _templateObject_fd3cedf0aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_HAXCMSLitElementThem) {
    ...
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_fd3cedf0aa9111ea8481a12db8bed9e6(), this.siteModalClick, this._goBack, this.icon, this.title, this.image, this.selectedPage, this.__mainPostsChanged, this.__mainPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject2_fd3cedf0aa9111ea8481a12db8bed9e6(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
        }), this.__extraPostsChanged, this.__extraPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject3_fd3cedf0aa9111ea8481a12db8bed9e6(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
          ...
          return (0, _litElement.html)(_templateObject4_fd3cedf0aa9111ea8481a12db8bed9e6(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_fd3cedf0aa9111ea8481a12db8bed9e6())];
      }
    }, {
      key: "tag",
      get: function get() {
