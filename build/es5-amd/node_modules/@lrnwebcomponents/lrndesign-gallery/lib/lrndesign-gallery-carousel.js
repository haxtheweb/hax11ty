define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "../../simple-tooltip/simple-tooltip.js", "../../../@polymer/iron-image/iron-image.js", "../../../@polymer/iron-icons/iron-icons.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _simpleTooltip, _ironImage, _ironIcons, _lrndesignGalleryZoom, _lrndesignGalleryDetails) {
  ...
  function _templateObject3_0c96d4a0aa9211ea8481a12db8bed9e6() {
    ...
    _templateObject3_0c96d4a0aa9211ea8481a12db8bed9e6 = function _templateObject3_0c96d4a0aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject2_0c96d4a0aa9211ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <button\n                    id=\"", "\"\n                    aria-controls=\"carousel\"\n                    class=\"gallerythumb\"\n                    .index=\"", "\"\n                    @click=\"", "\"\n                    ?disabled=\"", "\"\n                    .style=\"--lrndesign-gallery-thumb-url:url(", ");background-size:", "\"\n                  >\n                    <span class=\"sr-only\"\n                      >", "</span\n                    >\n                  </button>\n                  <simple-tooltip\n                    .for=\"", "\"\n                    ?hidden=\"", "\"\n                    position=\"top\"\n                  >\n                    ", "\n                  </simple-tooltip>\n                "]);

    _templateObject2_0c96d4a0aa9211ea8481a12db8bed9e6 = function _templateObject2_0c96d4a0aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_0c96d4a0aa9211ea8481a12db8bed9e6() {
    ...
    _templateObject_0c96d4a0aa9211ea8481a12db8bed9e6 = function _templateObject_0c96d4a0aa9211ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryCarousel, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_0c96d4a0aa9211ea8481a12db8bed9e6(), this.dark, this.extraWide, this.responsiveSize, this.hideNav, this.selected.xofy, this.selected.alt, this.selected.thumbnail, this.selected.sizing || this.sizing === "contain" || "cover", this.selected.src, this.selected.details, this.selected.heading, this.selected.large, this.selected.tooltip, this.selected.alt, this.hideNav, !this.selected || this.selected.prev < 0, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_0c96d4a0aa9211ea8481a12db8bed9e6(), item.id, item.index, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel), "styles", this)), [(0, _litElement.css)(_templateObject3_0c96d4a0aa9211ea8481a12db8bed9e6())]);
      }
    }, {
      key: "properties",
      get: function get() {
