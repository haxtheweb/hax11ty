define(["exports", "../../lit-element/lit-element.js", "../h-a-x/h-a-x.js"], function (_exports, _litElement, _hAX) {
  ...
  function _templateObject2_ee559f30aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_ee559f30aa9111ea8481a12db8bed9e6 = function _templateObject2_ee559f30aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function _templateObject_ee559f30aa9111ea8481a12db8bed9e6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h-a-x .app-store=\"", "\"></h-a-x>\n    "]);

    _templateObject_ee559f30aa9111ea8481a12db8bed9e6 = function _templateObject_ee559f30aa9111ea8481a12db8bed9e6() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(AppEditorHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ee559f30aa9111ea8481a12db8bed9e6(), this.appStoreConnection);
      }
    }, {
      key: "save",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_ee559f30aa9111ea8481a12db8bed9e6())];
      }
    }, {
      key: "tag",
      get: function get() {
