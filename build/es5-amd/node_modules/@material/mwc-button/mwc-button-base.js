define(["exports", "../../tslib/tslib.es6.js", "../mwc-icon/mwc-icon.js", "../mwc-ripple/ripple-directive.js", "../../lit-element/lit-element.js", "../../lit-html/directives/class-map.js"], function (_exports, _tslibEs, _mwcIcon, _rippleDirective, _litElement, _classMap) {
  ...
  function _templateObject2_51068c20a74f11ea82ee450f5068a39d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <mwc-icon class=\"mdc-button__icon\">\n        ", "\n      </mwc-icon>"]);

    _templateObject2_51068c20a74f11ea82ee450f5068a39d = function _templateObject2_51068c20a74f11ea82ee450f5068a39d() {
      return data;
    };
  ...
  function _templateObject_51068c20a74f11ea82ee450f5068a39d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n          id=\"button\"\n          class=\"mdc-button ", "\"\n          ?disabled=\"", "\"\n          aria-label=\"", "\">\n        <div class=\"mdc-button__ripple\"></div>\n        <span class=\"leading-icon\">\n          <slot name=\"icon\">\n            ", "\n          </slot>\n        </span>\n        <span class=\"mdc-button__label\">", "</span>\n        <slot></slot>\n        <span class=\"trailing-icon\">\n          <slot name=\"trailingIcon\">\n            ", "\n          </slot>\n        </span>\n      </button>"]);

    _templateObject_51068c20a74f11ea82ee450f5068a39d = function _templateObject_51068c20a74f11ea82ee450f5068a39d() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ButtonBase, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_51068c20a74f11ea82ee450f5068a39d(), (0, _classMap.classMap)(classes), this.disabled, this.label || this.icon, this.icon && !this.trailingIcon ? this.renderIcon(this.icon) : '', this.label, this.icon && this.trailingIcon ? this.renderIcon(this.icon) : '');
      }
    }, {
      key: "renderIcon",
      value: function renderIcon(icon) {
        return (0, _litElement.html)(_templateObject2_51068c20a74f11ea82ee450f5068a39d(), icon);
      }
    }, {
      key: "firstUpdated",
